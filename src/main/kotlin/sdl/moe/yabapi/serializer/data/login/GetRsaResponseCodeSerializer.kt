...
internal object GetRsaResponseCodeSerializer : KSerializer<RsaGetResponseCode> {
    override val descriptor: SerialDescriptor = PrimitiveSerialDescriptor(this.javaClass.simpleName, INT)

    override fun serialize(encoder: Encoder, value: RsaGetResponseCode): Unit = encoder.encodeString(value.name)
