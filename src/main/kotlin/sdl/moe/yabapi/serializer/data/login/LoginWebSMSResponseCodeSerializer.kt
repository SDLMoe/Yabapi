...
public object LoginWebSMSResponseCodeSerializer : KSerializer<LoginWebSMSResponseCode> {
    override val descriptor: SerialDescriptor = PrimitiveSerialDescriptor(this.javaClass.simpleName, INT)

    override fun serialize(encoder: Encoder, value: LoginWebSMSResponseCode): Unit = encoder.encodeString(value.name)

    override fun deserialize(decoder: Decoder): LoginWebSMSResponseCode =
