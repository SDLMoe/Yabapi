...
public data class VideoRights(
    ...
    @SerialName("is_stein_gate") val isInteractive: Boolean,
    @SerialName("is_cooperation") val isCooperation: Boolean,
    @SerialName("ugc_pay_preview") val canPayPreview: Boolean,
    @SerialName("no_background") val noBackground: Boolean,
    @SerialName("clean_mode") val isCleanMode: Boolean,
    @SerialName("is_360") val isPanoramic: Boolean,
